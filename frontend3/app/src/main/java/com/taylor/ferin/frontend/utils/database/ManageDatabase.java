package com.taylor.ferin.frontend.utils.database;
...
public class ManageDatabase extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_MEMBERSHIPTYPE_CLIENT = "membershipType";
    ...
    private static final String DATABASE_CREATE_CLIENT = " CREATE TABLE "
            ...
            + COLUMN_MEMBERSHIPTYPE_CLIENT + " TEXT  NOT NULL , "
