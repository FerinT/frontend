package com.taylor.ferin.frontend.repository.client.impl;
...
import com.taylor.ferin.frontend.utils.App;
import com.taylor.ferin.frontend.utils.database.DBConstants;
import com.taylor.ferin.frontend.utils.database.ManageDatabase;
...
public class ClientRepositoryImpl extends SQLiteOpenHelper implements ClientRepository{
    ...
    public Client findById(Long id) {
        ...
        if(cursor.moveToFirst())
        {
            ...
            String membershipType = cursor.getString(cursor.getColumnIndex(COLUMN_MEMBERSHIPTYPE));
    ...
    public Client save(Client entity) {
        ...
        values.put(COLUMN_MEMBERSHIPTYPE, entity.getMembershipType());
