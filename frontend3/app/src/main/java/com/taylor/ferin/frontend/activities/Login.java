package com.taylor.ferin.frontend.activities;
...
import com.taylor.ferin.frontend.activities.client.AddClientActivity;
import com.taylor.ferin.frontend.activities.client.Menu;
...
public class Login extends AppCompatActivity {
    ...
    String email = "";
    String idNumber = "";
    com.taylor.ferin.frontend.domain.login.Login login[] = null;
    Intent intent;
    ...
    private class HttpRequestTask extends AsyncTask<Void, Integer, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            HttpEntity<com.taylor.ferin.frontend.domain.login.Login> requestHttpEntity = new HttpEntity<>(requestHeaders);
            login = restTemplate.exchange(uri, HttpMethod.GET, requestHttpEntity, com.taylor.ferin.frontend.domain.login.Login[].class).getBody();
